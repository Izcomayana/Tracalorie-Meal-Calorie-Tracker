...
const ItemCtrl = (function () {
  ...
  return {
    ...
    getTotalCalories: function () {
      ...
      // Loop through items and calls
      data.items.forEach(function (item) {
        total += item.calories;
      });

      // Set total car in data structure
        ...
        html += `
          <li class="collection-item" id="item-${item.id}">
            ...
            <a href="#" class="secondary-content">
              <i class="edit-item fa fa-pencil">O</i>
            </a>
          </li>
        `;
      });
...
const AppCtrl = (function (ItemCtrl, StorageCtrl, UICtrl) {
  ...
  const loadEventListeners = function () {
    ...
    document
      ...
      // Update item event
      document.querySelector(UISelectors.updatedBtn).addEventListener('click', itemUpdateSubmit);
